...
class TithiNakshatraWidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == AppWidgetManager.ACTION_APPWIDGET_UPDATE || intent.action == ACTION_REFRESH_TITHI_WIDGET) {
            val appWidgetManager = AppWidgetManager.getInstance(context)
            val componentName = ComponentName(context, TithiNakshatraWidgetProvider::class.java)
    ...
    companion object {
        ...
        fun triggerUpdate(context: Context) {
            try {
                // Update our custom Tithi/Nakshatra widget
                val intent = Intent(context, TithiNakshatraWidgetProvider::class.java).apply {
